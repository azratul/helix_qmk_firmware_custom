...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
      ...
      ADJUST,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, RAISE,
      KC_LSFT, KC_NUBS, KC_LBRC, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
      KC_LCTL, KC_LGUI, KC_LALT, KC_PSCR, KC_QUOT, KC_RBRC, KC_SPC,  KC_SPC,  KC_RALT, KC_BSLS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
  /* Lower
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |      |      |      |      |      |      |             |      |      |      |      |      |      |
  ...
  [_RAISE] = LAYOUT(
      ...
      KC_MINS, _______, _______, _______, _______, KC_LPAD,                   KC_MENU, _______, _______, _______, _______, _______,
  ...
  [_ADJUST] =  LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______,                   _______, UG_NEXT, UG_HUED, UG_SATD, UG_VALD, ADJUST,

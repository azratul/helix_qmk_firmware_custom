...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
      ...
      KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_LBRC, KC_RBRC, KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
      KC_LCTL, KC_LGUI, KC_LALT, KC_PSCR, KC_QUOT, KC_MINS, KC_SPC,  KC_SPC,  KC_RALT, KC_BSLS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
  /* Lower
   * ,-----------------------------------------.             ,-----------------------------------------.
   * |      |      |      |      |      |      |             |      |      |      |      |      |      |
